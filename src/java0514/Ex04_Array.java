...
public class Ex04_Array {
	public static void main(String[] args) {
		...
		// System.out.println("다섯째 집 : " + num3[4]);  //집이 부족해서 안됨
		...
		char[] ch1 = {'훈' , '짱'}; //문자타입 변수
		String[] strl = {"인덱스0" , "인덱스1" , "인덱스2"}; //여러개 문자를 저장	
		
		System.out.println("String타입 str에서 2번째 집에 저장된 값 : ");
		...
		// for문을 이용해서 num3 배열에 저장된 값을 모두 출력
		// i=0 , length사용
	    //for (int i=1; i<=10; i++)
		for(int i=0; i<num3.length; i++) {
			System.out.println("num3[" + i + "]  " + num3[i]);
		}
		//국어 영어 수학 점수를 저장하고 배열변수에 저장된 모든 값의 총점과 평균을 구하여라
		...
		for(int i=0; i<numbers.length; i ++) {
			...
			double avg1 = sum / numbers.length; 
			System.out.println("numbers[] 총점 : "  + sum);
			System.out.println("numbers[] 평균 : "  + avg1);
